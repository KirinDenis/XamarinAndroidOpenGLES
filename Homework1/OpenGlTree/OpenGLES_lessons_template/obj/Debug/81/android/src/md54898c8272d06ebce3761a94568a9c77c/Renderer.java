package md54898c8272d06ebce3761a94568a9c77c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OpenGLES_lessons_template.Renderer, OpenGLES_lessons_template", Renderer.class, __md_methods);
	}
	...
	public Renderer ()
	{
		...
		if (getClass () == Renderer.class)
			mono.android.TypeManager.Activate ("OpenGLES_lessons_template.Renderer, OpenGLES_lessons_template", "", this, new java.lang.Object[] {  });
	}
