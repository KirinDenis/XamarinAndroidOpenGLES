...
namespace OpenGLES_lessons_template
{
    ...
    class Renderer : Java.Lang.Object, GLSurfaceView.IRenderer
    {
        ...
        private FloatBuffer mTriangle1Vertices2;
        ...
        private float angleInDegrees2 = 0;
        ...
        float[] triangle1VerticesData = {
                -0.5f, -0.25f, 0f,
                0.10f, 0.89f, 0.01f, 0.5f,

                0.5f, -0.25f, 0f,
                 0.75f, 0.95f, 0.50f, 0.3f,

                0.0f, 0.55f, 0f,
                0.30f, 0.1f, 0.10f, 0.1f
            };

        // X, Y, Z, 
        // R, G, B, A
        float[] triangle1VerticesData2 = {
                -0.5f, -0.25f, 0f,
                0.90f, 0.19f, 0.09f, 0.5f,

                0.5f, -0.25f, 0f,
                 0.15f, 0.15f, 0.50f, 0.3f,

                0.0f, 0.55f, 0f,
                0.90f, 0.9f, 0.90f, 0.1f
            };
        ...
        public void OnDrawFrame(IGL10 gl)
        {
            ...
            // Pass in the position information
            mTriangle1Vertices2.Position(mPositionOffset);
            GLES20.GlVertexAttribPointer(mPositionHandle, mPositionDataSize, GLES20.GlFloat, false, mStrideBytes, mTriangle1Vertices2);
            GLES20.GlEnableVertexAttribArray(mPositionHandle);

            // Pass in the color information
            mTriangle1Vertices2.Position(mColorOffset);
            GLES20.GlVertexAttribPointer(mColorHandle, mColorDataSize, GLES20.GlFloat, false, mStrideBytes, mTriangle1Vertices2);
            GLES20.GlEnableVertexAttribArray(mColorHandle);
            ...
            Matrix.SetIdentityM(mModelMatrix2, 0);
            Matrix.ScaleM(mModelMatrix2, 0, 0.4f, 0.4f, 0.4f);
            Matrix.TranslateM(mModelMatrix2, 0, 0.0f, 0.0f, 0.0f);
            Matrix.RotateM(mModelMatrix2, 0, angleInDegrees2+80, 0, 0.0001F, 0);
            Matrix.MultiplyMM(mMVPMatrix, 0, mViewMatrix, 0, mModelMatrix2, 0);
            Matrix.MultiplyMM(_mMVPMatrix, 0, mProjectionMatrix, 0, mMVPMatrix, 0);
            GLES20.GlUniformMatrix4fv(mMVPMatrixHandle, 1, false, _mMVPMatrix, 0);
            GLES20.GlDrawArrays(GLES20.GlTriangles, 0, 3);
