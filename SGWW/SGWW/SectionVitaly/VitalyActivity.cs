...
namespace SGWW
{
    ...
    public class VitalyActivity : AppCompatActivity, View.IOnTouchListener
    {
        private GLSurfaceView _GLSurfaceView;
        private VitalyView vitalyView;
        private VitalyRenderer renderer;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_vitaly);

            _GLSurfaceView = new GLSurfaceView(this);
            _GLSurfaceView.SetEGLContextClientVersion(2);
            
            renderer = new VitalyRenderer(this);
            ...
            vitalyView = new VitalyView(this);
            vitalyView.render = renderer;
            vitalyView.SetOnTouchListener(this);

            sceneHolder.AddView(vitalyView);
