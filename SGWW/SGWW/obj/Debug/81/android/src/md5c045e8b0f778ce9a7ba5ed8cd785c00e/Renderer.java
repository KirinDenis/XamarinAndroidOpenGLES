...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SGWW.Renderer, SGWW", Renderer.class, __md_methods);
	}
	...
	public Renderer ()
	{
		...
		if (getClass () == Renderer.class)
			mono.android.TypeManager.Activate ("SGWW.Renderer, SGWW", "", this, new java.lang.Object[] {  });
	}
	...
	public Renderer (android.content.Context p0)
	{
		super ();
		if (getClass () == Renderer.class)
			mono.android.TypeManager.Activate ("SGWW.Renderer, SGWW", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
