...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SGWW.PublicRenderer, SGWW", PublicRenderer.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PublicRenderer.class)
			mono.android.TypeManager.Activate ("SGWW.PublicRenderer, SGWW", "", this, new java.lang.Object[] {  });
	}

	public PublicRenderer (android.content.Context p0)
	{
		super ();
		if (getClass () == PublicRenderer.class)
			mono.android.TypeManager.Activate ("SGWW.PublicRenderer, SGWW", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
