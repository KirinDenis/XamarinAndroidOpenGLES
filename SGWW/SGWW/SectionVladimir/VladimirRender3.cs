...
namespace SGWW
{
 ...
 // X, Y, Z,             
        ...
        public VladimirRender3VBO(Context context)
        {
        ...
        public void OnSurfaceCreated(IGL10 gl, Javax.Microedition.Khronos.Egl.EGLConfig config)
        {
            ...
            float[] colorArray = new float[test1[1].Length / 4];
            System.Buffer.BlockCopy(test1[0], 0, colorArray, 0, (int)test1[1].Length);

            modelVerticesData = vertexArray;

            modelColorsData = colorArray;
        ...
        public void OnDrawFrame(IGL10 gl)
        {
            ...
            Matrix.ScaleM(mModelMatrix, 0, 2f, 2f, 0.5f);
            Matrix.TranslateM(mModelMatrix, 0, 0f,0f, 0.0f);
            Matrix.RotateM(mModelMatrix, 0, angleInDegrees, 1.0f, 0.0f, 0.0f);

            Matrix.MultiplyMM(mMVPMatrix, 0, mViewMatrix, 0, mModelMatrix, 0);
            Matrix.MultiplyMM(_mMVPMatrix, 0, mProjectionMatrix, 0, mMVPMatrix, 0);
            GLES20.GlUniformMatrix4fv(mMVPMatrixHandle, 1, false, _mMVPMatrix, 0);
            GLES20.GlDrawArrays(GLES20.GlTriangles, 0, modelVerticesData.Length / 3);
