...
namespace SGWW
{
    ...
    public class SergekActivity : AppCompatActivity, View.IOnTouchListener
    {
        ...
        private SergekRenderer renderer;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_sergek);

            _GLSurfaceView = new GLSurfaceView(this);
            _GLSurfaceView.SetEGLContextClientVersion(2);
            
            renderer = new SergekRenderer(this);
            ...
            sergekView = new SergekView(this);
            sergekView.render = renderer;
            sergekView.SetOnTouchListener(this);

            sceneHolder.AddView(sergekView);
